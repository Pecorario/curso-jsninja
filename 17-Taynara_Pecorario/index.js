(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Taynara Pecorario'));
  ...
  */
  ...
  function replaceDate ( arg, day, month, year) {

    console.log(month.split(' '));
    return `${day}/${getMonthNumber(month.split(' ')[2])}/${year.split(' ')[2]}`;
